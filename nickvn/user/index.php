	...
	<div class="col-md-12">
		<div class="text-center" style="margin-top: -128px;">
			<center>
				...
				<img class="img-responsive img-thumbnail hidden-xs" width="256" height="256" src="https://noidangsong.vn/files/uploads/fb1735058496563345/1526444239-tt_avatar_small.jpg" alt="">
				<?php }else{ ?>
