...
<?php if($TMQ['admin'] == 9){ ?>
                    ...
                    <li>
                        <a href="/admin/setting_bingo.php"> <i class="menu-icon ti-gift"></i>Tỉ lệ vòng quay bingo</a>
                    </li></li>
                    <li>
                        <a href="/admin/setting_wheelvk.php"> <i class="menu-icon ti-gift"></i>Tỉ lệ vòng quay vòng quay vũ khí</a>
                    </li>
...
<?php if($TMQ['admin'] == 9){ ?>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="/admin/bingo.php"> <i class="menu-icon fa fa-history"></i>Vòng quay bingo</a>
                    </li>
                     <li>
