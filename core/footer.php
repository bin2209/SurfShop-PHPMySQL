	<footer>
		...
		<br>
		<br>
		<a href="https://fb.com/LSTsurf/" target="_blank"><img class="icon-social" src="img/icon/facebook.png"></a>
		<a href="mailto:lst.surf.skate@gmail.com" target="_blank"><img class="icon-social" src="img/icon/mail.png"></a>
		<br>
