    ...
    <div class="card">
      <div class="card-body">
        ...
        $array_category = array("None",
          array("Surf","Surf Board","Fins","Leaches","Tractions"),
          array("Skate","Skate Board","Decks","Trucks","Wheels","Grips","Brearings","Hardwares"),
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              //  CATEGORY - TYPE
                    ...
                    echo '<tr>';
                    echo '<td>'.$id.' <img src="../../uploads/products/'.$images.'" alt="image" / ></td>';
                    echo ' <td>'.$name.'</td>';
                    echo ' <td>'.$brand.'</td>';
