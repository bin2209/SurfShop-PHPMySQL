...
<div class="clip_pr">
    ...
    ?>
                ...
                <div style="display: block;" class="fitler">
                    ...
                    <ul>
<li><p>Số vàng tối thiểu</p><input class="only_num" onkeyup="format_price(this)" maxlength="20" id="int_3" value="" /></li>
        ...
        <script>
            ...
            function load_account(){
                $(".list_account").hide();
                $("#loading").show();
                $.post("../assets/ajax/lqm.php", { status : status , min_price : min_price , max_price : max_price , int_1 : int_1 , int_2 : int_2 , int_3 : int_3 , int_4 : int_4 , int_5 : int_5 , high_light : high_light , varchar_1 : varchar_1 , varchar_2 : varchar_2 , varchar_3 : varchar_3 , varchar_4 : varchar_4 , varchar_5 : varchar_5 , longtext_1 : longtext_1 , longtext_2 : longtext_2 , longtext_3 : longtext_3 , server : server , page : page })
                .done(function(data) {
                    $(".list_account").html('');
